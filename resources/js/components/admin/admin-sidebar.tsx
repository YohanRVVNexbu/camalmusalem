...
const solicitudesItems: NavItem[] = [
    ...
    { title: 'Cotizaciones nuevos',        href: '/admin/cotizaciones-vehiculos?tipo=nuevo',     icon: Receipt },
    { title: 'Cotizaciones seminuevos',    href: '/admin/cotizaciones-vehiculos?tipo=seminuevo', icon: Receipt },
