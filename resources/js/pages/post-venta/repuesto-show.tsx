...
export default function RepuestoShow({ repuesto, footer, whatsapp }: { repuesto: Repuesto; footer: any | null; whatsapp?: PostventaWhatsappConfig }) {
                ...
                <div className="px-5 pt-25 pb-15 lg:px-15 lg:pt-15 lg:pb-50">
                    ...
                    <div className="mt-7.5 flex flex-col gap-5 lg:hidden">
                        ...
                        <div className="flex flex-col gap-2.5">
                            ...
                            <PostventaWhatsapp config={whatsapp ?? null} productName={repuesto.name} />
                        </div>
