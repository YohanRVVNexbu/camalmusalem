...
export default function MerchShow({ merch, footer, whatsapp = null }: { merch: Merch; footer: any | null; whatsapp?: PostventaWhatsappConfig }) {
    const [currentImage, setCurrentImage] = useState(0);
    const images = merch.images?.length ? merch.images : [];
    ...
    return (
        <>
            <Head title={`${merch.name} — Merch Toyota Musalem`} />
                ...
                <div className="px-5 pt-25 pb-15 lg:px-15 lg:pt-15 lg:pb-50">
                    ...
                    <div className="mt-7.5 flex flex-col gap-5 lg:hidden">
                        ...
                        <div className="relative overflow-hidden rounded-[20px]">
                            {images[currentImage] ? (
                                <img src={images[currentImage]} alt={merch.name} className="aspect-square w-full bg-white object-contain" />
                            ) : (
                        ...
                        {merch.size && (
                            <div className="flex flex-col gap-1.5">
                                <span className="text-base leading-none text-black/60" style={{ fontFamily: '"Toyota Type"' }}>Talla:</span>
                                <div className="rounded-[10px] bg-[#EAEAF1] p-4">
                                    <span className="text-base font-semibold uppercase leading-none text-black" style={{ fontFamily: '"Toyota Type"' }}>{merch.size}</span>
                                </div>
                            </div>
                        )}
                        ...
                        <div className="flex flex-col gap-1.5">
                            ...
                            <div className="rounded-[10px] bg-[#EAEAF1] p-4">
                                <span className="text-2xl font-semibold uppercase leading-none text-black" style={{ fontFamily: '"Toyota Type"' }}>{merch.price ? formatCLP(merch.price) : '—'}</span>
                            </div>
                        </div>
                        ...
                        <div className="flex flex-col gap-2.5">
                            <Link
                                href={`/post-venta/merch/${merch.id}/cotizar`}
                            ...
                            <PostventaWhatsapp config={whatsapp} productName={merch.name} />
                        </div>
                    ...
                    <div className="mt-10 hidden items-start gap-5 lg:flex">
                        ...
                        <div className="flex w-[65%] flex-col gap-5">
                            ...
                            <div className="relative overflow-hidden rounded-[20px]">
                                {images[currentImage] ? (
                                    <img src={images[currentImage]} alt={merch.name} className="h-120 w-full bg-white object-contain" />
                                ) : (
                        ...
                        <div className="flex w-[35%] flex-col gap-5 rounded-[20px] bg-[#EAEAF1] px-7.5 pt-7.5 pb-7.5">
                            ...
                            {merch.size && (
                                <div className="flex flex-col gap-1.5">
                                    <span className="text-lg leading-none text-black/60" style={{ fontFamily: '"Toyota Type"' }}>Talla:</span>
                                    <div className="rounded-[10px] p-4" style={{ background: 'rgba(0,0,0,0.06)' }}>
                                        <span className="text-lg font-semibold uppercase leading-none text-black" style={{ fontFamily: '"Toyota Type"' }}>{merch.size}</span>
                                    </div>
                                </div>
                            )}
                            ...
                            <div className="flex flex-col gap-1.5">
                                ...
                                <div className="rounded-[10px] p-4" style={{ background: 'rgba(0,0,0,0.06)' }}>
                                    <span className="text-[28px] font-semibold uppercase leading-none text-black" style={{ fontFamily: '"Toyota Type"' }}>{merch.price ? formatCLP(merch.price) : '—'}</span>
                                </div>
                            </div>
