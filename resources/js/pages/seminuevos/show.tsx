...
export default function SeminuevosShow({ seminuevo, footer, certificateBadge, whatsapp }: { seminuevo: Seminuevo; footer: any | null; certificateBadge?: string | null; whatsapp?: PostventaWhatsappConfig }) {
    ...
    const vehicleName = `${seminuevo.brand} ${seminuevo.model} ${seminuevo.year}`;
                ...
                <div className="px-5 pt-25 pb-25 lg:px-15 lg:pt-15 lg:pb-50">
                    ...
                    <div className="mt-7.5 flex flex-col gap-5 lg:hidden">
                        ...
                        <div className="flex flex-col gap-2.5">
                            ...
                            <PostventaWhatsapp config={whatsapp ?? null} productName={vehicleName} />
                        </div>
