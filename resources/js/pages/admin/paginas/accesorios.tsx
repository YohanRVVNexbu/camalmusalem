...
export default function AccesoriosPage({ sections }: { sections: Record<string, SectionProp> }) {
    ...
    const s = sections['accesorios_hero'];
    ...
    return (
        <AdminLayout breadcrumbs={[
            ...
            <Head title="Admin — Accesorios (Hero)" />
            <div className="flex flex-col gap-4 p-4">
                <h1 className="text-2xl font-semibold">Accesorios y Merch — Hero</h1>
                {flash?.success && (
                ...
                <SectionCard page={page} sectionKey="accesorios_hero" label="Hero" isVisible={visible}
                    ...
                    onSubmit={(e) => { e.preventDefault(); submitSection(page, 'accesorios_hero', data, visible, { hero_image: file }, setProcessing); }}
