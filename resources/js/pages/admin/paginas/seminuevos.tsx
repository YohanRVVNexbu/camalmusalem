    ...
    return (
        <AdminLayout breadcrumbs={[
            ...
            <div className="flex flex-col gap-4 p-4">
                ...
                <WhatsappSelector
                    page={page}
                    sectionKey="seminuevos_whatsapp"
                    s={sections['seminuevos_whatsapp']}
                    label="Botón WhatsApp (detalle de seminuevos)"
                    description="Aparece en el detalle de cada seminuevo. El mensaje usa {producto} para insertar el nombre del vehículo."
                    defaultMessage="Hola, me interesa este vehículo: {producto}"
                />
            </div>
        </AdminLayout>
    );
