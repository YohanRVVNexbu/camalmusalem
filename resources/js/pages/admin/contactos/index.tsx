...
export default function ContactosIndex({ contactos }: { contactos: Contacto[] }) {
    ...
    const eliminar = (id: number) => {
        if (confirm('¿Eliminar este mensaje?')) {
            router.delete(`/admin/contactos/${id}`);
        }
    };
    ...
    return (
        <AdminLayout breadcrumbs={[{ title: 'Dashboard', href: '/admin' }, { title: 'Contactos', href: '/admin/contactos' }]}>
                            ...
                            >
                                <div className="flex items-start justify-between gap-4">
                                    <div className="flex flex-1 flex-col gap-1 min-w-0">
                                        ...
                                        <p className="text-sm text-muted-foreground whitespace-pre-wrap">{c.mensaje}</p>
                                    </div>
